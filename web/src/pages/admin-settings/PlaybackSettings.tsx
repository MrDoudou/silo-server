    ...
    <div className="flex h-full flex-col">
      <div className="mb-6 space-y-2">
        ...
        <p className="text-muted-foreground text-sm leading-relaxed">
          Turn transcoding on, pick hardware acceleration, and set when titles count as watched.
          FFmpeg paths and chapter thumbnails are under Advanced.
        </p>
      </div>
      ...
      <div className="flex-1 space-y-6">
        <FieldGroup label="Transcoding">
          <SettingField
            ...
            type="toggle"
            hint="Required when a client cannot direct-play the file. Direct play still works when this is off."
          ...
          {form.getValue("playback.transcode_enabled") !== "false" && (
            <>
              ...
              <SettingField
                ...
                type="toggle"
                hint="Off by default. 4K transcodes are expensive; leave this off unless you need them."
        ...
        <FieldGroup label="Watched state">
          <SettingField
        ...
        <AdvancedSection description="FFmpeg paths, transcode throttling, and chapter thumbnail extraction. Defaults are fine for a single-node install.">
          <SettingField
            label="FFmpeg Path"
          ...
          <SettingField
            ...
            type="number"
            hint="Global chapter thumbnail dispatcher concurrency. Default 1."
